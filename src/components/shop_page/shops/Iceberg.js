...
import {Iceberg_items}  from "../shopDetels/ShopItems"
import "./shop.css"
                    ...
                    <div className="menu">
                        ...
                        <div className="itName">
                            ...
                            <div className="nameHading same" id="2">
                                ...
                                {/* {Iceberg_items .Pizza.map(showCase)} */}
                                {
                                    Iceberg_items.Sandwich.map((val) => (
                                        <IteamComp
                                            key={val.id}
                                            Itname={val.name}
                                            amount={val.amount}
                            ...
                            <div className="nameHading same" id="3">
                                ...
                                {/* {Iceberg_items .Vada_pav.map(showCase)} */}
                                {
                                    Iceberg_items.Burger.map((val) => (
                                        <IteamComp
                                            key={val.id}
                                            Itname={val.name}
                                            amount={val.amount}
                            ...
                            <div className="nameHading same" id="4">
                                ...
                                {/* {Iceberg_items .dabeli.map(showCase)} */}
                                {
                                    Iceberg_items.Pizza.map((val) => (
                                        <IteamComp
                                            key={val.id}
                                            Itname={val.name}
                                            amount={val.amount}
                            ...
                            <div className="nameHading same" id="5">
                                ...
                                {/* {Iceberg_items .Fix_Thali.map(showCase)} */}
                                {
                                    Iceberg_items.Shake.map((val) => (
                                        <IteamComp
                                            key={val.id}
                                            Itname={val.name}
                                            amount={val.amount}
