...
import Shreeji_items from "../shopDetels/ShopItems"
import "./shop.css"
                    ...
                    <div className="menu">
                        ...
                        <div className="itName">
                            ...
                            <div className="nameHading same" id="3">
                                ...
                                {/* {Shreeji_items.Vada_pav.map(showCase)} */}
                                {
                                    Shreeji_items.Vada_pav.map((val) => (
                                        <IteamComp
                                            key={val.id}
                                            Itname={val.name}
                                            amount={val.amount}
                            ...
                            <div className="nameHading same" id="4">
                                ...
                                {/* {Shreeji_items.dabeli.map(showCase)} */}
                                {
                                    Shreeji_items.dabeli.map((val) => (
                                        <IteamComp
                                            key={val.id}
                                            Itname={val.name}
                                            amount={val.amount}
                            ...
                            <div className="nameHading same" id="5">
                                ...
                                {/* {Shreeji_items.Fix_Thali.map(showCase)} */}
                                {
                                    Shreeji_items.Fix_Thali.map((val) => (
                                        <IteamComp
                                            key={val.id}
                                            Itname={val.name}
                                            amount={val.amount}
